-- Homelessnes Data (Homeless + SUD Count)
-- This code identifies individuals who indicated "Homeless"
...
IF OBJECT_ID (N'tempdb.dbo.##HomelessSample') IS NOT NULL
	DROP TABLE ##HomelessSample
...
-- Select SUD and Total Cost fields from claims table
...
-- Create a TempTable for SUD and Total Cost
...
-- Add isSUDDx and Total Cost from #SUDandTotalCost to TempTable #HomelessSample
